...
const TournamentHistory = () => {
		...
		return (
			<div className="flex items-center space-x-4">
				<div className="flex items-center">
					...
					{aviatorWon && <Trophy className="ml-1 h-4 w-4 text-yellow-500" />}
				</div>
				<span>vs</span>
				<div className="flex items-center">
					...
					{producerWon && <Trophy className="ml-1 h-4 w-4 text-yellow-500" />}
				</div>
	...
	return (
		<div className="container mx-auto p-4">
			<h1 className="mb-6 text-3xl font-bold">Tournament History</h1>
			...
			<Tabs defaultValue="history">
				<TabsList className="mb-6 w-full">
					...
					<TabsTrigger value="player-stats" className="flex-1">
						Player Statistics
					</TabsTrigger>
				</TabsList>
				...
				<TabsContent value="history">
					<Card>
						<CardHeader>
							...
							<CardDescription>History of all past Rowdy Cup tournaments</CardDescription>
						</CardHeader>
						<CardContent>
							{isHistoryLoading ? (
								...
								<div className="py-4 text-center text-gray-500">No tournament history found.</div>
							)}
						</CardContent>
					</Card>
				</TabsContent>
