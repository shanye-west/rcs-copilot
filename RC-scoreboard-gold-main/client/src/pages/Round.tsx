											...
											<div className="space-y-6">
												<div>
													<p className="text-muted-foreground mb-2 text-sm font-medium">
														Match Type:{' '}
														<span className="text-foreground font-bold">{round.matchType}</span>
													</p>
													<p className="text-muted-foreground mb-4 text-sm">
														You need to select {playersPerTeam} player
														{playersPerTeam > 1 ? 's' : ''} for each team
													</p>
												</div>
												...
												{isPlayersLoading || isParticipantsLoading ? (
													...
													<>
														...
														<div>
															<div className="mb-2 flex items-center justify-between">
																<label className="block text-sm font-medium">
																	Aviators Team Players ({matchFormData.aviatorPlayerIds.length}/
																	{playersPerTeam})
																</label>
															</div>
														...
														<div>
															<div className="mb-2 flex items-center justify-between">
																<label className="block text-sm font-medium">
																	Producers Team Players ({matchFormData.producerPlayerIds.length}/
																	{playersPerTeam})
																</label>
															</div>
