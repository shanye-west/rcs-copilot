 ...
 */
export function calculateGrossScore(scores: Score[], playerId: string, hole: number): number | undefined {
 ...
 */
export function calculateNetScore(scores: Score[], playerId: string, hole: number): number | undefined {
 ...
 */
export function calculateMatchStatus(playerA: Player, playerB: Player, scores: Score[], holes: number[]): string {
  let aUp = 0, bUp = 0;
 ...
 */
export function getWinningTeam(teamAScore: number | undefined, teamBScore: number | undefined): 'A' | 'B' | 'tie' | null {
